...
use App\Domain\Invoice\Factories\CreateInvoiceRowServiceFactory;
...
class InvoiceRowCreateJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try 
        {
            (CreateInvoiceRowServiceFactory::create())->createRows($this->invoicePayload);
